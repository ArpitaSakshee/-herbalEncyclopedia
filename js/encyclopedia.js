document.addEventListener('DOMContentLoaded', function () {
  ...
  herbs.forEach((herb, index) => {
    ...
    productItem.href = `./herb_detail.html?herb=${index + 1}`;
    let productImage = document.createElement('img');
    productImage.src = herb.imageSrc;
    productImage.alt = herb.herbName;
    productImage.classList.add('product-img');
    let productName = document.createElement('p');
    productName.classList.add('product-name');
    productName.innerText = herb.herbName;
    productItem.appendChild(productImage);
    productItem.appendChild(productName);
    document.getElementById('herb-list').appendChild(productItem);
  });
});
